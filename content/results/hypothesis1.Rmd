---
title: "Hypothesis 1"
description: "The use of the term “diversity” and related terminology increased in biomedical abstracts from 1990-2020"
...
```{r figure 1a, fig.height=6.5, echo=FALSE}
`%notin%` <- Negate(`%in%`)
