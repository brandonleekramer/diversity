...
figure_2B <- h2_omb_prcs %>% 
  ggplot() + 
  geom_line(aes(y = prc_black, x = year, colour = "black"), size = 1, stat="identity") +
  geom_line(aes(y = prc_white, x = year, colour = "white"),size = 1, stat="identity") +
  ...
  geom_line(aes(y = prc_diversity, x = year, colour = "diversity (social)"), size = 1, stat="identity") +
