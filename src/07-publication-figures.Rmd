...
for (pkg in c("tidyverse", "igraph", "tidytext", "ggplot2", 
              "grid", "gridExtra", "cowplot", "reshape2", "wesanderson",
...
scale_color_manual(values=c("#6b0f6b", "#61B329", "#E21F00", "#E2B306", "#E86F00", "#3B9AB2",  "#00468b", "#d23ccc"))  # 8 color palette - first graphs 

scale_color_manual(values=c("#E21F00", "#3B9AB2", "#61B329", "#E2B306"))  # 4 color palette - 3A + 3B graphs

scale_color_manual(values=c("#61B329", "#3B9AB2", "#E21F00", "#00468b", "#d23ccc", "#6b0f6b",  "#E86F00", "#E2B306"))  # 8 color palette - last graphs 
