...
```{r abstract text analysis, messages = FALSE, warning=FALSE, echo=FALSE}
...
```{r appendix 1, rows.print=25, fig.width=9.5, echo=FALSE}
nodeList %>% 
  filter(cluster == "1") %>%
...
```{r appendix 2, rows.print=25, fig.width=9.5, echo=FALSE}
nodeList %>% 
  filter(cluster == "3") %>%
  rename(term = nName) %>% select(-ID)
```
...
```{r appendix 3, rows.print=50, fig.width=9.5, echo=FALSE}
nodeList %>% 
...
```{r appendix 4, fig.width=9.5, echo=FALSE}
