...
pubmed_data <- dbGetQuery(conn, "SELECT * FROM pubmed_2021.abstract_data LIMIT 10000;")
...
### BEFORE RUNNING I WOULD HAVE TO UPDATE THIS TO REFLECT THE NEW CODING OF DIVERSITY IN CONTEXT 
...
biomed_abstract_data <- pubmed_data %>% 
  unnest_tokens(word, abstract) %>% 
  anti_join(stop_words) %>% # run this since the dataset is so huge now 
