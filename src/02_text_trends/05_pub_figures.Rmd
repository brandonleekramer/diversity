...
figure_1A <- general_pop_terms %>% 
  ...
  geom_line(aes(y = lifecourse, x = year, colour = "lifecourse"), size = 0.8, stat="identity", linetype = "dotted") +
  geom_line(aes(y = `sex/gender`, x = year, colour = "sex/gender"), size = 0.8, stat="identity", linetype = "dotted") +
  geom_line(aes(y = `diversity (all)`, x = year, colour = "diversity (all)"), size = 0.8, stat="identity", linetype = "dotted") +
  geom_line(aes(y = socioeconomic, x = year, colour = "socioeconomic"), size = 0.8, stat="identity", linetype = "longdash") +
  geom_line(aes(y = disability, x = year, colour = "disability"), size = 0.8, stat="identity", linetype = "longdash") +
  geom_line(aes(y = `race/ethnicity`, x = year, colour = "race/ethnicity"), size = 0.8, stat="identity", linetype = "longdash") +
  ...
  geom_line(aes(y = `diversity (social)`, x = year, colour = "diversity (social)"), size = 0.8, stat="identity", linetype = "dotdash") +
  geom_line(aes(y = minority, x = year, colour = "minority"), size = 0.8, stat="identity", linetype = "dotdash") +
  geom_line(aes(y = minority, x = year, colour = "migration"), size = 0.8, stat="identity", linetype = "dotdash") +
  theme_minimal() + 
  ...
  scale_color_manual(labels=c("cultural", "disability", "diversity (all)","diversity (social)", "equity", "lifecourse",
                     ...
                     #values=c("#D3D3D3",  "#D3D3D3",    "#696969",        "#696969",            "#000000",  "#000000", 
                    #          "#D3D3D3", "#000000",   "#000000",    "#D3D3D3",  "#696969", "#696969")
                     ) +
...
figure_1B_pre <- general_pop_terms %>% 
  ...
  ggplot() + 
  geom_line(aes(y = prc_lifecourse, x = year, colour = "lifecourse"), size = 0.8, stat="identity", linetype = "dotted") +
  geom_line(aes(y = prc_sexgender, x = year, colour = "sex/gender"), size = 0.8, stat="identity", linetype = "dotted") +
  geom_line(aes(y = prc_diversity, x = year, colour = "diversity (all)"), size = 0.8, stat="identity", linetype = "dotted") +
  geom_line(aes(y = prc_class, x = year, colour = "socioeconomic"), size = 0.8, stat="identity", linetype = "longdash") +
  geom_line(aes(y = prc_disability, x = year, colour = "disability"), size = 0.8, stat="identity", linetype = "longdash") +
  geom_line(aes(y = prc_racial, x = year, colour = "race/ethnicity"), size = 0.8, stat="identity", linetype = "longdash") +
  geom_line(aes(y = prc_cultural, x = year, colour = "cultural"), size = 0.8, stat="identity", linetype = "solid") +
  geom_line(aes(y = prc_equity, x = year, colour = "equity"), size = 0.8, stat="identity", linetype = "solid") +
  geom_line(aes(y = prc_sexuality, x = year, colour = "sexuality"), size = 0.8, stat="identity", linetype = "solid") +
  geom_line(aes(y = prc_soc_diversity, x = year, colour = "diversity (social)"), size = 0.8, stat="identity", linetype = "dotdash") +
  geom_line(aes(y = prc_minority, x = year, colour = "minority"), size = 0.8, stat="identity", linetype = "dotdash") +
  geom_line(aes(y = prc_migration, x = year, colour = "migration"), size = 0.8, stat="identity", linetype = "dotdash") +
