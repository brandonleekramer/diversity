...
figure_1A <- h1_all_set_counts_trends %>% 
  ...
  geom_line(aes(y = `diversity (all)`, x = year, colour = "diversity (all)"), size = 0.8, stat="identity", linetype = "solid") +
  ...
  geom_line(aes(y = `diversity (social)`, x = year, colour = "diversity (social)"), size = 0.8, stat="identity", linetype = "solid") +
  geom_line(aes(y = minority, x = year, colour = "minority"), size = 0.8, stat="identity", linetype = "solid") +
  geom_line(aes(y = minority, x = year, colour = "migration"), size = 0.8, stat="identity", linetype = "solid") +
  theme_minimal() + 
...
figure_1B_pre <- general_pop_terms %>% 
  ...
  ggplot() + 
  geom_line(aes(y = prc_lifecourse, x = year, colour = "lifecourse"), size = 0.8, stat="identity", linetype = "solid") + #dotted
  geom_line(aes(y = prc_sexgender, x = year, colour = "sex/gender"), size = 0.8, stat="identity", linetype = "solid") + #dotted
  geom_line(aes(y = prc_diversity, x = year, colour = "diversity (all)"), size = 0.8, stat="identity", linetype = "solid") + #dotted
  geom_line(aes(y = prc_class, x = year, colour = "socioeconomic"), size = 0.8, stat="identity", linetype = "solid") + #longdash
  geom_line(aes(y = prc_disability, x = year, colour = "disability"), size = 0.8, stat="identity", linetype = "solid") + #longdash
  geom_line(aes(y = prc_racial, x = year, colour = "race/ethnicity"), size = 0.8, stat="identity", linetype = "solid") + #longdash
  ...
  geom_line(aes(y = prc_soc_diversity, x = year, colour = "diversity (social)"), size = 0.8, stat="identity", linetype = "solid") + #dotdash
  geom_line(aes(y = prc_minority, x = year, colour = "minority"), size = 0.8, stat="identity", linetype = "solid") + #dotdash
  geom_line(aes(y = prc_migration, x = year, colour = "migration"), size = 0.8, stat="identity", linetype = "solid") + #dotdash
...
figure_3A <- h3_counts %>%   
  ...
  scale_color_manual(labels=c("all population terms", "continental", "directional", 
                              "diversity (social)", "national", "omb/us-census", 
